...
logger = logging.getLogger("MISO.math.t_mathematics.optimizations.mlx_backend_enhancer")
...
class MLXBackendEnhancer:
    ...
    def __init__(self, enable_telemetry=True):
        ...
        Args:
            enable_telemetry: Aktiviert Leistungstelemetrie
        """
    ...
    def enhance_backend(self, backend):
        ...
        # Optimiere Speichertransfers (nur Telemetrie, keine Änderung der Implementation)
    ...
    def _enhance_memory_transfers(self, backend):
        ...
        Da die Benchmarks gezeigt haben, dass die ursprüngliche Implementierung
        bereits optimal ist, wird hier nur Telemetrie hinzugefügt.
...
def get_enhancer(enable_telemetry=True):
    """
    ...
    if _enhancer_instance is None:
        _enhancer_instance = MLXBackendEnhancer(enable_telemetry=enable_telemetry)
    return _enhancer_instance

def optimize_mlx_backend(backend, enable_telemetry=True):
    """
    ...
    Returns:
        Optimiertes Backend
    """
    enhancer = get_enhancer(enable_telemetry=enable_telemetry)
